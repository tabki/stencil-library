...
function minifyStyle(config, compilerCtx, buildCtx, styleText) {
...
function setStyleText(config, compilerCtx, buildCtx, cmpMeta, styleMeta, styles) {
    return __awaiter$36(this, void 0, void 0, function* () {
        ...
        if (config.minifyCss) {
            styleMeta.compiledStyleText = yield minifyStyle(config, compilerCtx, buildCtx, styles.join(''));
        }
        else {
...
function scanDirForTsFiles(config, fs$$1, dir) {
    return __awaiter$55(this, void 0, void 0, function* () {
        ...
        yield Promise.all(tsFileItems.map((tsFileItem) => __awaiter$55(this, void 0, void 0, function* () {
