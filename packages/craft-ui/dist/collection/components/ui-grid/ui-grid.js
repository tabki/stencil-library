...
export function createGridItemArray(gridItemNodeList, totalColumns) {
    var gridItemArray = [];
...
export function getGridItemRowPosition(row, currentIndex, gridItemColSize, totalColumns) {
...
export function calcGridItemWidth(columnSize, gutter, totalColumns) {
    /*
...
export function setGridItemWidth(gridItemElement, columnSize, gutter, totalColumns) {
...
const renderGrid = gridConf => {
    var gridItemRows = sortGridItemsIntoRows(gridConf.gridItemArray, gridConf.cols);
...
export class UIGrid {
    ...
    static get style() { return "/**style-placeholder:ui-grid:**/"; }
}
